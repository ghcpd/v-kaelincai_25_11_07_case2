...
parser = argparse.ArgumentParser(description='Simple static server for pre-improvement UI')
...
class CustomHandler(SimpleHTTPRequestHandler):
    def translate_path(self, path):
        # Serve a flat directory, but allow /data/ to serve from data_dir
    ...
    def end_headers(self):
        # prevent caching for easier testing
