# PowerShell script to run tests for Project B (Post-Improvement UI)

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "Project B - Post-Improvement UI Test Runner" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Starting HTTP server on port 8002..." -ForegroundColor Yellow
...
Write-Host "  - Logs: $projectRoot\logs\log_post.txt" -ForegroundColor White
Write-Host "  - Results JSON: $projectRoot\results\results_post.json" -ForegroundColor White
Write-Host ""

# Check if results exist
if (Test-Path "$projectRoot\results\results_post.json") {
    $results = Get-Content "$projectRoot\results\results_post.json" | ConvertFrom-Json
